...
OUTPUT_DIR = r"../../Results/EyeTracking/Landmark/Microsaccades_Per_Epoch"
...
def create_microsaccade_histogram(ms_counts, total_epochs, num_subjects):
    ...
    # Customize plot
    plt.title('Distribution of Microsaccades per Epoch - Landmark\n',
    ...
    plt.savefig(os.path.join(OUTPUT_DIR, 'Microsaccades_Per_Epoch_Distribution_Landmark.png'),
